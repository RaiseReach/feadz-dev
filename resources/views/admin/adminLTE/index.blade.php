    ...
    <section class="sidebar">
      ...
      <form method="post" class="sidebar-form">
        <div class="input-group">
          <input type="text" name="name" class="form-control" placeholder="Enter name (stats)">
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">Unknown<small></small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{ $graphics['count_posts'] }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{ $graphics['count_users'] }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">New Members Today</span>
              <span class="info-box-number">{{ $graphics['count_users_today'] }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-8">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  ...
                  <div class="box-tools pull-right">
                    <span class="label label-danger">{{ count($graphics['latest_members']) }} New Members</span>
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    @foreach($graphics['latest_members'] as $member)
                    @php
                    $member_photo = $member->photo == '' ? '/source/img/default-avatar.png' : '/files/uploads/' . $member->photo;
                    @endphp
                    <li>
                      <img width="128" height="128" src="{{ $member_photo }}" alt="User Image">
                      <a class="users-list-name" href="{{ url($member->name )}}">{{ $member->name }}</a>
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tbody>
                  @foreach($graphics['latest_posts'] as $post)
                  <tr>
                    <td><a href="{{ url($post->author_name) }}">{{ $post->author_name }}</a></td>
                    <td><span class="label label-success">{{ $post->type }}</span></td>
                    <td><a href="{{ url($post->author_name, $post->url) }}">{{ $post->description_title }}</a></td>
                    <td><a href="{{ url($post->author_name, $post->url) }}">{{ $post->description_text}}</a></td>
                  </tr>
                  @endforeach
                  </tbody>
                </table>
            ...
            <div class="box-footer clearfix">
              <a href="/admin/posts" class="btn btn-sm btn-default btn-flat pull-right">View All Posts</a>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /.box -->
        ...
        <div class="col-md-4">
          ...
          <div class="info-box bg-green">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{ $graphics['count_likes'] }}</span>
          ...
          <div class="info-box bg-aqua">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{ $graphics['count_comments'] }}</span>
