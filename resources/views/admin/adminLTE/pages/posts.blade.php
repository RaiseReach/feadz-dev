...
<head>
  ...
  <title>Feadz - Admin panel / List of posts</title>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <td style="text-align: center;">
                  ...
                  <small class="label pull-right bg-green viewPost" data-url="{{ url($post->author_name, $post->url) }}" style="float: none !important; cursor: pointer;">View</small>
                  <small class="label pull-right bg-blue editPost" data-author_name="{{ $post->author_name }}" data-url="{{ $post->url }}" style="float: none !important; cursor: pointer;">Edit</small>
                  <small class="label pull-right bg-red deletePost" data-id="{{ $post->id }}" style="float: none !important; cursor: pointer;">Delete</small>
                </td>
                </tr>
                @endforeach
                </tbody>
...
<script>
  ...
  $('.editPost').click(function() {
    ...
    window.open('/admin/edit/'+author_name+'/' + url);
  });
