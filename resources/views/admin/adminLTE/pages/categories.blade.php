        ...
        <div class="col-md-12">
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Modifying / Adding / Deleting categories</h3>
            ...
            <div class="hidden-category input-group margin" style="display: none;">
                <input type="text" class="form-control" name="category">
                <input type="hidden" name="category_id" value="">
                <span class="input-group-btn">
                  <button type="button" class="btn btn-info btn-flat save-category">SAVE</button>
                  <button type="button" class="btn btn-danger btn-flat delete-category">DELETE</button>
                </span>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                @endforeach
                <button type="button" class="btn btn-block btn-primary btn-xs add-category">ADD NEW CATEGORY</button>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Сategory successfully saved!</p>
          </div>
...
<script>
    $('button.add-category').click(function() {
        var clone = $('.hidden-category:first').clone();
        $(clone).show();
        $(this).before(clone);
    });

    $('body').on('click', '.save-category', function() {
        var category = $(this).parents('.input-group').find('input[name="category"]').val();
        var category_id = $(this).parents('.input-group').find('input[name="category_id"]').val();
        $.ajax({
            url: '/admin/action/save-category',
            method: 'POST',
            data: {'_token' : '{{ csrf_token() }}', 'category' : category, 'category_id' : category_id },
    ...
    $('body').on('click', '.delete-category', function() {
        var category_id = $(this).parents('.input-group').find('input[name="category_id"]').val();
        $.ajax({
            url: '/admin/action/delete-category',
            method: 'POST',
